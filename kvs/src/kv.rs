...
const PATH: &str = "/home/raws4uce/projects/kvs/src/log.txt"; //obviously change this to a txt file in your own dir, 
                                                                // yes i use linux
...
impl KvStore {
    ...
    fn offset_map_init(log: &String) -> HashMap<String, usize> {
